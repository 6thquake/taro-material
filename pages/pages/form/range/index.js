          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                数值范围：
                {this.state.value1[0]}~{this.state.value1[1]}
              </View>
              <AtRange value={[20, 60]} onChange={this.handleChange.bind(this, 'value1')} />
            </View>
          </View>
          {/* 自定义样式 */}
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                数值范围：
                {this.state.value2[0]}~{this.state.value2[1]}
              </View>
              <AtRange
