        ...
        <View className="doc-body">
          ...
          <View className="panel">
            ...
            <View className="panel__content no-padding">
              ...
              <View className="example-item">fixed：是否是固定定位。默认为false。Boolean值</View>
              <View className="example-item">raised：是否显示阴影。默认为false。Boolean值</View>
              <View className="example-item">
              ...
              <View className="example-item">
                color:组件的背景色。String可取的值：'default' | 'inherit' | 'primary' | 'secondary'
