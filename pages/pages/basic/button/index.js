...
import { AtButton, AtForm, AtFab } from 'taro-material';
...
export default class ButtonPage extends Taro.Component {
  ...
  onSubmit() {
    Taro.showModal({
      content: `submit event detail: ${JSON.stringify(arguments[0].detail)}`,
      showCancel: false,
    });
  }
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="btn-item">
                <AtButton type="primary" onClick={this.onButtonClick.bind(this)}>
                  主操作按钮
                </AtButton>
              </View>
              <View className="btn-item">
                <AtButton type="primary" loading onClick={this.onButtonClick.bind(this)}>
                  Loading
                </AtButton>
              </View>
              <View className="btn-item">
