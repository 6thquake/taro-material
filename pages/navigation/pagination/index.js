...
import AtPagination from '../../taro-material/components/pagination/index';
        ...
        <View className="doc-body">
          ...
          <View className="panel">
            ...
            <View className="panel__content no-padding">
              <View className="example-item">
                <AtPagination pickerSelect total={20} pageSize={10} current={1} />
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                <AtPagination pickerSelect icon total={20} pageSize={10} current={1} />
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                ...
                <View className="btn-item">
                  <AtButton type="primary" onClick={this.onPageDataChange.bind(this)}>
                    增加10条数据
                  </AtButton>
                </View>
                <View className="btn-item">
