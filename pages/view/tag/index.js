...
import AtTag from '../../taro-material/components/tag/index';
...
export default class TagPage extends Taro.Component {
  ...
  onClick(data) {
    ...
    const content = `您点击的 tag 标签名是：${data.name}，点击前是否选中：${
      data.active
    }，点击后：${active}`;
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                ...
                <View className="subitem">
                  <AtTag size="small" circle active>
                    标签
                  </AtTag>
                </View>
                <View className="subitem">
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                ...
                <View className="subitem">
                  <AtTag size="small" type="primary" circle active>
                    标签
                  </AtTag>
                </View>
                <View className="subitem">
