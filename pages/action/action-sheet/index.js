...
import AtActionSheet from '../../taro-material/components/action-sheet';
import AtActionSheetItem from '../../taro-material/components/action-sheet/body/item/index';
  ...
  render() {
    ...
    return (
      <View className="page">
        ...
        >
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮一')}>
            按钮一
          </AtActionSheetItem>
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮二')}>
            按钮二
          </AtActionSheetItem>
        </AtActionSheet>
        ...
        >
          ...
          <AtActionSheetItem onClick={this.showToast.bind(this, '成功清除位置')}>
