...
import AtModal from '../../taro-material/components/modal/index';
import AtModalHeader from '../../taro-material/components/modal/header/index';
import AtModalContent from '../../taro-material/components/modal/content/index';
import AtModalAction from '../../taro-material/components/modal/action/index';
      ...
      <View className="page">
        ...
        <View className="doc-body">
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                <AtButton onClick={this.handleClick.bind(this, 1)}>打开基础模态框</AtButton>
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                <AtButton onClick={this.handleClick.bind(this, 2)}>打开单个按钮模态框</AtButton>
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                <AtButton onClick={this.handleClick.bind(this, 3)}>打开无标题模态框</AtButton>
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                <AtButton onClick={this.handleClick.bind(this, 4)}>打开简化使用模态框</AtButton>
              </View>
            </View>
          </View>
        </View>
