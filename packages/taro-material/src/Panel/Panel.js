    ...
    return (
      <View className='root'>
        <View onClick={this.handleClick} className='header'>
          <View className='left'>
            <View className='name'>
              <RMTypography block={true} className='subheading'>{title}</RMTypography>
            </View>
            <View className='company'>
              <RMTypography block={true} className='caption'>{subheading}</RMTypography>
            </View>
          </View>
        ...
        {(!expandable || expanded) && <View className='body'>
          {this.props.children}
        </View>}
        {(!expandable || expanded) && <View className='footer'>
          {
            actions.map((item)=>{
