  ...
  render() {
    ...
    return (
      <View className={rootCls}>
        ...
        <View className='info'>
          <View className='text'>
            <RMTypography className='body2' color={_color} fontSize='inherit'>{text}</RMTypography>
          </View>
              ...
              signature.split('').map((char, index)=>{
                ...
                return (
                  <View className={cls} key={index}>
                    <RMTypography className='caption' color={_color} fontSize='inherit'>{char}</RMTypography>
                  </View>
                )
              }) 
            }
